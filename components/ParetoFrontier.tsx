...
const DEFAULT_POINTS: ParetoModelPoint[] = [
  {
    id: "sentinel-70b",
    model: "Sentinel-70B",
    safetyScore: 96,
...
export function ParetoFrontier({ points = DEFAULT_POINTS }: ParetoFrontierProps) {
    ...
    <section className="overflow-hidden rounded-md border border-neutral-800 bg-black font-mono text-white">
      ...
      <div className="grid gap-0 sm:grid-cols-3">
        ...
        <div className="border-b border-neutral-800 px-5 py-4 sm:border-b-0 sm:border-r sm:border-neutral-800">
          ...
          <p className="mt-1 text-2xl font-black text-white">{getFrontier(points).length}</p>
        </div>
